...
Public Class Form1
    ...
    Private Sub cbPreview_Click(sender As System.Object, e As System.EventArgs) Handles cbPreview.Click
    ...
    Private Sub clbWallpaper_SelectedIndexChanged(sender As System.Object, e As System.EventArgs) Handles clbWallpaper.SelectedIndexChanged
    ...
    Private Sub timerWall_Tick(sender As System.Object, e As System.EventArgs) Handles TimerWall.Tick
        Try
...
vbCrLf & "anton@ti.ukdw.ac.id")
    ...
    Private Sub Label1_Click(sender As Object, e As EventArgs) Handles lblPath.Click
    ...
    Private Sub ToolStripStatusLabel1_Click(sender As Object, e As EventArgs) Handles ToolStripStatusReady.Click
    ...
    Private Sub MenuStrip2_ItemClicked(sender As Object, e As ToolStripItemClickedEventArgs) Handles MenuStrip1.ItemClicked

    End Sub

    Private Sub lblInterval_Click(sender As Object, e As EventArgs) Handles lblInterval.Click

    End Sub

    Private Sub ComboBox1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cbInterval.SelectedIndexChanged
